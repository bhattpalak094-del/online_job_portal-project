...
include '../db.php';
  ...
  // Fetch confirmed applicants and their respective company emails
$sql = "
...
WHERE a.cname='$cname' AND a.j_title='$j_title' AND a.jname='$jname' AND a.status = 'reject'"; // Assuming 'status' is used to track application confirmation
...
echo "
<script>
alert('No rejected applyers found.');
...
try {
    ...
    $mail->Body = "Dear Applicant, <br>Your application has been rejected.";
